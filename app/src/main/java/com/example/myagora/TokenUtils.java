...
public class TokenUtils {
    ...
    public static void gen(Context context, String appid,String certificate,String channelName,  int uid, OnTokenGenCallback<String> onGetToken){
        gen(appid,certificate, channelName, uid, ret -> {
            if(onGetToken != null){
                runOnUiThread(() -> {
